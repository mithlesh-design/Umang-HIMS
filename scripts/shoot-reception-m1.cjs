/* M1 verification: reception dashboard (overview) + moved OPD queue + nav sections. */
...
;(async () => {
  ...
  await sleep(2500)
  await shot('m1-rc-dashboard')

  await click(page, 'OPD Queue', 'a'); await sleep(1200); await shot('m1-rc-opd')
