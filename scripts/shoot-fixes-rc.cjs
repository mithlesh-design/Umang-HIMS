...
;(async () => {
  ...
  await click(page, 'Operations', 'button'); await click(page, 'Reception', 'button'); await sleep(2200)

  await shot('fix-dashboard')                                   // admission alerts + patients-today=6
  await click(page, 'OPD Queue', 'a'); await sleep(1000); await shot('fix-opd')   // no yesterday patients on board
  await click(page, 'Patients', 'a'); await sleep(1000); await shot('fix-patients-today')
  await click(page, 'Yesterday', 'button'); await sleep(700); await shot('fix-patients-yesterday')
  await click(page, 'Reports', 'a'); await sleep(1100); await shot('fix-reports')
