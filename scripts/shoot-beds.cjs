...
;(async () => {
  ...
  await click(page, 'Operations', 'button'); await click(page, 'Reception', 'button'); await sleep(2000)
  await click(page, 'Bed Status', 'a'); await sleep(1200)
  await page.screenshot({ path: `${OUT}\\beds-turnaround.png` }); console.log('shot beds-turnaround')
  await browser.close()
