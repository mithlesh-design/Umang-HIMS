/* M2 verification: OPD triage ordering + richer cards + AI walk-in suggestion. */
...
;(async () => {
  ...
  await sleep(2000)
  await click(page, 'OPD Queue', 'a'); await sleep(1200); await shot('m2-opd-board')

  // Open walk-in and trigger AI triage suggestion
  await click(page, 'Register Walk-in', 'button'); await sleep(600)
  await page.type('#wi-name', 'Test Patient')
  await page.type('#wi-phone', '9876500000')
  await page.type('#wi-symptoms', 'chest pain and breathless')
  await sleep(700); await shot('m2-walkin-ai')
