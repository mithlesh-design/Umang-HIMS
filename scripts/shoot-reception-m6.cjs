/* M6 verification: messaging / downloads / reports / setup. */
...
;(async () => {
  ...
  await click(page, 'Messaging', 'a'); await sleep(1100); await shot('m6-messages')
  await click(page, 'Team inbox', 'button'); await sleep(600); await shot('m6-inbox')
  await click(page, 'Download Center', 'a'); await sleep(1000); await shot('m6-downloads')
  await click(page, 'Reports', 'a'); await sleep(1200); await shot('m6-reports')
  await click(page, 'Setup', 'a'); await sleep(1000); await shot('m6-setup')
