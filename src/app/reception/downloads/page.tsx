              ...
              return (
                <div key={d.id} className="flex items-center gap-3 p-3 rounded-2xl bg-slate-50">
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    <button onClick={() => printableHtml(d.name, `<div class="hdr"><div><h1>AGENTIX HIMS</h1><h2>${d.name}</h2></div><div style="text-align:right"><b>${new Date().toLocaleDateString('en-IN')}</b></div></div><p style="font-size:13px"><b>Type:</b> ${d.cat}</p><p style="font-size:12px;color:#64748b">This is a system-generated demo document.</p>`)}
