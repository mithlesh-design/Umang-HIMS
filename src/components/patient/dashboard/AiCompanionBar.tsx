...
export function AiCompanionBar() {
  ...
  return (
    <div
      className="rounded-3xl shadow-[0_8px_28px_rgba(14,116,144,0.25)] p-4"
      style={{
        background: 'linear-gradient(#fff,#fff) padding-box, linear-gradient(to right,#0E7490,#1E97B2,#0E7490) border-box',
